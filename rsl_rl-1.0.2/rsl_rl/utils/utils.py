...
def resolve_callable(callable_or_name: type | Callable | str) -> Callable:
    ...
    - Simple name: for example ``"PPO"``, ``"ActorModel"``, or ``"MLPModel"``.
    ...
    common_callables = {
        ...
        "OnPolicyRunner": "rsl_rl.runners:OnPolicyRunner",
        "ActorModel": "rsl_rl.models:ActorModel",
        "MLPModel": "rsl_rl.models:MLPModel",
        ...
        "TeacherKLPlugin": "rsl_rl.algorithms.plugins:TeacherKLPlugin",
        "AMPPlugin": "rsl_rl.algorithms.plugins:AMPPlugin",
    }
    if callable_or_name in common_callables:
        callable_or_name = common_callables[callable_or_name]
